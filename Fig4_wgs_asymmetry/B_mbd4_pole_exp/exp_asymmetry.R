...
#===============get mutl data==================
mutl.p5<-apply(p5[mutl,],2,sum)/10
mutl.p3<-apply(p3[mutl,],2,sum)/10
...
barplot(mutl.data,beside=F,col=cl,border=cl,space= rep(rep(c(1,0.2),6),2),axisnames=F,axes=F,ylab="")
axis(2,at=c(0,20000,40000,60000,80000,100000),labels =c(0,20000,40000,60000,80000,100000) )
